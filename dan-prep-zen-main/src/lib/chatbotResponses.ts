...
const queryMatches = (query: string, patterns: string[]) => patterns.some((pattern) => query.includes(pattern));

const getClarifyingResponse = (userName?: string | null) => {
...
export const getChatbotResponse = (userQuery: string, userName?: string | null) => {
